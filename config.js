...
BOT_NAME: process.env.BOT_NAME || "�SHADOW BOT",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "•᭄͢❈NIGHT SHADOW ᪣᭄",
...
ALIVE_MSG: process.env.ALIVE_MSG || "_salut users je suis shadow bot._",
// add alive msg here 
